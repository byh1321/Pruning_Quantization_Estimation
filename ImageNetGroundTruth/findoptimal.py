...
parser.add_argument('--netsel', default=3, type=float, help='choose network to use')
...
def acc_based_search():
    ...
    #best_c, best_q, best_p, best_acc_actual, best_nparam = \
    #        grad_based_search(best_c, best_q, best_p, power_c, power_q, power_p, get_actual_acc(best_c, best_q, best_p), best_nparam)
    #exit()
